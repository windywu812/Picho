    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            if indexPath.row == 0 {
                ...
                datePicker.addTarget(self, action: #selector(handleDataPicker(sender:)), for: .valueChanged)
...
extension NotificationViewController: UNUserNotificationCenterDelegate {
    func userNotificationCenter(_: UNUserNotificationCenter, willPresent _:

...
class ProfileViewController: UITableViewController {
    ...
    override init(style _: UITableView.Style = .grouped) {
        ...
        if indexPath.section == 1 {
            ...
            if indexPath.row == 0 {
                if HealthKitService.shared.checkAuthorization() {
                    ...
                    alert.addAction(UIAlertAction(title: NSLocalizedString("Go to Setting", comment: ""), style: UIAlertAction.Style.default, handler: { _ in
